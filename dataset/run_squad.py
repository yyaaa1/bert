...
if __name__ == "__main__":
    ...
    examples = read_squad_examples(search_input_file=args.dev_search_input_file)
    features = convert_examples_to_features(examples=examples, tokenizer=tokenizer,max_seq_length=args.max_seq_length, max_query_length=args.max_query_length)
